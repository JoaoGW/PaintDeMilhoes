 ...
 * valor (gets e sets). Também contém as equações para que seja possível a criação desse pincel.
 ...
 */
public class PincelGr extends Pincel {
     ...
     */
    public PincelGr(int x1, int y1, int x2, int y2, Color cor, String nome, int esp){
        super (x1, y1, x2, y2);
        setCorReta(cor);
        setNomeReta(nome);
        setEspReta(esp);
     ...
     * @param cor Color. Cor da reta
     */
    public PincelGr(int x1, int y1, int x2, int y2, Color cor){
        super (x1, y1, x2, y2);
        setCorReta(cor);
        setNomeReta("");
    }   
     ...
     * @param esp int. Espessura da reta
     */
    public PincelGr(int x1, int y1, int x2, int y2, Color cor, int esp){
        super (x1, y1, x2, y2);
        setCorReta(cor);
        setNomeReta("");
        setEspReta(esp);
     ...
     * @param y2 int. Coordenada y2
     */
    public PincelGr(int x1, int y1, int x2, int y2){
        super (x1, y1, x2, y2);
     ...
     */
    public PincelGr(PontoGr p1, PontoGr p2){
        super(p1, p2);
        setCorReta(Color.black);
        setNomeReta("");
    }    
     ...
     * @param cor Color. Cor da reta
     */
    public PincelGr(PontoGr p1, PontoGr p2, Color cor){
        super(p1, p2);
        setCorReta(cor);
        setNomeReta("");
    }    
     ...
     * @param nome String. Nome da reta
     */
    public PincelGr(PontoGr p1, PontoGr p2, Color cor, String str){
        super(p1, p2);
        setCorReta(cor);
        setNomeReta(str);
    }    
    ...
    public void verificarPincel(Graphics g){
        if(p1.getX() < p2.getX()){
            desenharPincel1(g);
        }
    ...
    // ESQ pra DIR
    public void desenharPincel1(Graphics g){
    ...
    // DIR pra ESQ
    public void desenharPincel2(Graphics g){
        // calcula m e b da equacao da reta y = mx + b
        double m = calcularM();
        double b = calcularB();
        double m2 = calcularM2();
    ...
    public void desenharPincel3(Graphics g){
        // calcula m e b da equacao da reta y = mx + b
        double m = calcularM();
        double b = calcularB();
    ...
    public void desenharPincel4(Graphics g){
        // calcula m e b da equacao da reta y = mx + b
        double m = calcularM();
        double b = calcularB();
