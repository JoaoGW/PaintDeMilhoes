 ...
 * Verifica as características da borracha para cada caso possível.
 *
 ...
 */
public class BorrachaGr extends Borracha
{
     ...
     */
    public BorrachaGr(int x1, int y1, int x2, int y2, Color cor, String nome, int esp){
        super (x1, y1, x2, y2);
        setCorReta(cor);
        setNomeReta(nome);
        setEspReta(esp);
     ...
     * @param cor Color. Cor da reta
     */
    public BorrachaGr(int x1, int y1, int x2, int y2, Color cor){
        super (x1, y1, x2, y2);
        setCorReta(cor);
        setNomeReta("");
    }   
     ...
     * @param esp int. Espessura da reta
     */
    public BorrachaGr(int x1, int y1, int x2, int y2, Color cor, int esp){
        super (x1, y1, x2, y2);
        setCorReta(cor);
        setNomeReta("");
        setEspReta(esp);
     ...
     * @param y2 int. Coordenada y2
     */
    public BorrachaGr(int x1, int y1, int x2, int y2){
        super (x1, y1, x2, y2);
     ...
     */
    public BorrachaGr(PontoGr p1, PontoGr p2){
        super(p1, p2);
        setCorReta(Color.black);
        setNomeReta("");
    }    
     ...
     * @param cor Color. Cor da reta
     */
    public BorrachaGr(PontoGr p1, PontoGr p2, Color cor){
        super(p1, p2);
        setCorReta(cor);
        setNomeReta("");
    }    
     ...
     * @param nome String. Nome da reta
     */
    public BorrachaGr(PontoGr p1, PontoGr p2, Color cor, String str){
        super(p1, p2);
        setCorReta(cor);
        setNomeReta(str);
    }    
