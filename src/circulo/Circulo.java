 ...
 * valor (gets e sets). Também contém as equações para que seja possível a criação do cicrculo.
 *
...
public class Circulo
{
     ...
     */
    public Circulo(int x, int y, int xc, int yc) {
        setP1(new Ponto(x, y));
     ...
     * @param y2 coordenada y de p2
     */
    public Circulo(double x, double y, double xc, double yc) {
        setP1(new Ponto(x, y));
        setP2(new Ponto(xc, yc));
    }
