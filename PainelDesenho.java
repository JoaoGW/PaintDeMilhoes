...
import poligono.FiguraPoligono;
...
public class PainelDesenho extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public void mousePressed(MouseEvent e) { 
        ...
        if (tipo == TipoPrimitivo.PONTO){
            ...
            if (primeiraVez == true) {
                ...
                segundaVez = true;
                paint(g);
            }else if(primeiraVez == true && segundaVez == true && terceiraVez == false){
                x4 = (int)e.getX();
                y4 = (int)e.getY();
                primeiraVez = true;
                segundaVez = true;
                terceiraVez = true;
                paint(g);
            }else if(primeiraVez == true && segundaVez == true && terceiraVez == true && quartaVez == false){
                x5 = (int)e.getX();
                y5 = (int)e.getY();
                primeiraVez = true;
                segundaVez = true;
                ...
                quartaVez = true;
                paint(g);
            }else if(primeiraVez == true && segundaVez == true && terceiraVez == true && quartaVez == true && quintaVez == false){
                x6 = (int)e.getX();
                y6 = (int)e.getY();
                primeiraVez = true;
                segundaVez = true;
                ...
                quintaVez = true;
                paint(g);
            }else if(primeiraVez == true && segundaVez == true && terceiraVez == true && quartaVez == true && quintaVez == true && sextaVez == false){
                x7 = (int)e.getX();
                y7 = (int)e.getY();
                primeiraVez = true;
                segundaVez = true;
                ...
                sextaVez = true;
                paint(g);
            }else if(primeiraVez == true && segundaVez == true && terceiraVez == true && quartaVez == true && quintaVez == true && sextaVez == true && setimaVez == false){
                x8 = (int)e.getX();
                y8 = (int)e.getY();
                primeiraVez = true;
                segundaVez = true;
    ...
    public void desenharPrimitivos(Graphics g){
        ...
        if (tipo == TipoPrimitivo.PONTO){
            ...
            listaSave.adicionarPontoLista("PONTO", x, y);
        }
        ...
        if (tipo == TipoPrimitivo.RETA){
            ...
            String pontoDesenhado = "RETA: " + x1 + "," + y1 + " ; " + x2 + "," + y2 + " --> ";
            fileM.escrevaArquivo(pontoDesenhado);

            //Registra um novo elemento a lista ligada
            listaSave.adicionarRetaLista("RETA", x1, y1, x2, y2);
        }
        ...
        if (tipo == TipoPrimitivo.RETANGULO){
            ...
            String pontoDesenhado = "RETANGULO: " + x1 + "," + y1 + " ; " + x2 + "," + y2 + " --> ";
            fileM.escrevaArquivo(pontoDesenhado);

            //Registra um novo elemento a lista ligada
            listaSave.adicionarRetaLista("RETANGULO", x1, y1, x2, y2);
        }
        ...
        if (tipo == TipoPrimitivo.TRIANGULO){
            ...
            String pontoDesenhado = "TRIANGULO: " + x1 + "," + y1 + " ; " + x2 + "," + y2 + " ; " + x3 + "," + y3 + " --> ";
            fileM.escrevaArquivo(pontoDesenhado);

            //Registra um novo elemento a lista ligada
            listaSave.adicionarTrianguloLista("TRIANGULO", x1, y1, x2, y2, x3, y3);
        }   
        ...
        if (tipo == TipoPrimitivo.CIRCULO){
            ...
            String pontoDesenhado = "CIRCULO: " + x1 + "," + y1 + " ; " + x2 + "," + y2 + " --> ";
            fileM.escrevaArquivo(pontoDesenhado);

            //Registra um novo elemento a lista ligada
            listaSave.adicionarRetaLista("CIRCULO", x1, y1, x2, y2);
        }
        ...
        //Caso a opção selecionada seja o poligono
        if (tipo == TipoPrimitivo.POLIGONO){
            FiguraPoligono.desenharPoligono(g, x1, y1, x2, y2, x3, y3, x4, y4, x5, y5, x6, y6, x7, y7, x8, y8, "", getEsp(), getCorAtual());
        }
